...
violation[matches] {
  ...
  gen_rego_result_50 = (version != null)
  
  gen_rego_result_50 == true
...
violation[matches] {
  ...
  # custom2
  version = object.get(x, "apiContract:version", null)
  gen_rego_result_52 = (version != null)
  
  gen_rego_result_52 != true
...
gen_path_rule_53[nodes] {
  x = data.sourceNode
  nodes_tmp = object.get(x,"apiContract:version",[])
...
violation[matches] {
  ...
  gen_path_rule_53_node_array = gen_path_rule_53 with data.sourceNode as x
  gen_path_rule_53_node = gen_path_rule_53_node_array
  gen_rego_result_54 = (gen_path_rule_53_node != null) # custom 3
  gen_rego_result_54 != true
  _result_0 := trace("rego","apiContract.version",gen_path_rule_53_node,"Violation in native Rego constraint")
