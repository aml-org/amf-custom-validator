package profile_test17

report["profile"] = "Test17"
...
violation[matches] {
  ...
  version = object.get(x, "http://a.ml/vocabularies/core#version", null)
  ...
  matches := error("custom-message",x, message ,[_result_0])
}