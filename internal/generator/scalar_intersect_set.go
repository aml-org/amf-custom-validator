...
func GenerateScalarIntersectSetRule(hasValue profile.ScalarSetRule) []SimpleRegoResult {
	...
	rego = append(rego, fmt.Sprintf("%s = { \"%s\"}", containsSomeVariable, strings.Join(hasValue.Argument, "\",\"")))
