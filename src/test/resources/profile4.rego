...
violation[matches] {
 target_class[x] with data.class as "apiContract:Parameter"
  ...
  _result_0 := trace("minCount", count(gen_propValues_1), "Value not matching minCount 1")
...
violation[matches] {
 target_class[x] with data.class as "apiContract:Parameter"
  ...
  _result_1 := trace("minCount", count(gen_propValues_2), "Value not matching minCount 1")
